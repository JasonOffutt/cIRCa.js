...
var WebServer = (function () {
	var http,
		...
		registerRoutes = function () {
			...
			app.put('/api/v1/bots/:id', routes.api.bots.update);
			app.post('/api/v1/bots', routes.api.bots.create);
			app.delete('/api/v1/bots/:id', routes.api.bots.destroy);
		...
		return {
			...
			configure: function (root, sessionStore) {
				rootDir = root;
